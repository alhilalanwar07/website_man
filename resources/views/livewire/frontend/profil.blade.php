<div>
    ...
    <section class="relative py-20 sm:py-24 lg:py-28 overflow-hidden bg-slate-950 noise">
        <div class="absolute inset-0">
            <div class="absolute top-[-20%] left-[-10%] w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] bg-blue-600/20 rounded-full blur-[80px] sm:blur-[100px] animate-blob"></div>
            <div class="absolute bottom-[-10%] right-[-5%] w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] bg-indigo-600/15 rounded-full blur-[60px] sm:blur-[80px] animate-blob" style="animation-delay:2s"></div>
            <div class="absolute top-[40%] right-[15%] w-[150px] sm:w-[200px] h-[150px] sm:h-[200px] bg-purple-500/10 rounded-full blur-[60px] sm:blur-[80px] animate-float-slow"></div>
        </div>
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute bottom-[20%] right-[10%] w-12 h-12 border border-blue-400/20 rounded-full animate-float-reverse hidden sm:block"></div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <span class="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-blue-300 glass rounded-full uppercase tracking-wider mb-4 sm:mb-6 animate-fade-up">
            ...
            <p class="text-base sm:text-lg text-slate-400 max-w-2xl animate-fade-up delay-200">Mengenal lebih dekat SMK Negeri 1 Kolaka, visi misi, serta komitmen kami dalam mencetak generasi unggul.</p>
        </div>
    </section>
    ...
    <section class="py-16 sm:py-24 lg:py-28 bg-white relative overflow-hidden">
        <div class="absolute top-0 right-0 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] bg-gradient-to-bl from-blue-50 to-indigo-50 rounded-full blur-[100px] sm:blur-[140px] -translate-y-1/3 translate-x-1/3 opacity-70"></div>
        <div class="absolute bottom-0 left-0 w-[300px] h-[300px] bg-gradient-to-tr from-slate-50 to-blue-50 rounded-full blur-[80px] translate-y-1/3 -translate-x-1/3 opacity-60"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 sm:gap-12 lg:gap-20 items-start">
                ...
                <div class="lg:col-span-2 relative">
                    {{-- Decorative borders --}}
                    <div class="absolute -top-3 -left-3 w-full h-full rounded-3xl border-2 border-blue-200/30 hidden sm:block"></div>
                    <div class="absolute -bottom-3 -right-3 w-full h-full rounded-3xl border-2 border-indigo-200/20 hidden sm:block"></div>
                    ...
                    <div class="relative z-10 rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/10 mx-auto max-w-xs sm:max-w-sm lg:max-w-none">
                        ...
                        <div class="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent pt-14 sm:pt-16 pb-4 sm:pb-5 px-4 sm:px-5">
                            ...
                            <p class="text-white/70 text-[10px] sm:text-xs font-semibold tracking-widest uppercase mt-0.5">Kepala Sekolah</p>
                        </div>
                        @endif
                    </div>
                ...
                <div class="lg:col-span-3">
                    <span class="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-blue-600 bg-blue-50 rounded-full uppercase tracking-wider mb-4 sm:mb-6">
    ...
    <section class="py-16 sm:py-24 lg:py-28 bg-slate-50 relative overflow-hidden">
        <div class="absolute bottom-0 left-0 w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] bg-indigo-50 rounded-full blur-[80px] sm:blur-[120px] translate-y-1/2 -translate-x-1/2"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                <div class="bg-white p-6 sm:p-8 lg:p-10 rounded-[20px] sm:rounded-[28px] border border-slate-100 card-hover">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-blue-500/20">
                ...
                <div class="bg-white p-6 sm:p-8 lg:p-10 rounded-[20px] sm:rounded-[28px] border border-slate-100 card-hover">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-indigo-500/20">
    ...
    <section class="py-16 sm:py-24 lg:py-28 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 sm:mb-14">
                ...
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-slate-900">Data <span class="text-gradient">Sekolah</span></h2>
            </div>
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                @if($profil->npsn)
                <div class="bg-slate-50 rounded-[16px] sm:rounded-[24px] p-5 sm:p-7 card-hover border border-slate-100">
                    <div class="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
                ...
                <div class="bg-slate-50 rounded-[16px] sm:rounded-[24px] p-5 sm:p-7 card-hover border border-slate-100">
                    <div class="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
                ...
                <div class="bg-slate-50 rounded-[16px] sm:rounded-[24px] p-5 sm:p-7 card-hover border border-slate-100">
                    <div class="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-purple-400 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4">
