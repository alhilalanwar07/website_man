<div class="space-y-8">
    ...
    <section class="grid grid-cols-1 gap-4 md:grid-cols-2 2xl:grid-cols-4">
        @foreach($stats as $stat)
            ...
            <article wire:key="dash-stat-{{ Str::slug($stat['label']) }}" class="group relative overflow-hidden rounded-[1.6rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900">
        ...
        <div class="overflow-hidden rounded-[1.8rem] border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div class="divide-y divide-slate-100 dark:divide-slate-800">
                @forelse($recentBerita as $berita)
                    <article wire:key="dash-berita-{{ $berita->id }}" class="flex flex-col gap-4 px-6 py-4 md:flex-row md:items-center md:justify-between">
                        <div class="min-w-0">
            ...
            <div class="overflow-hidden rounded-[1.8rem] border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="divide-y divide-slate-100 dark:divide-slate-800">
                    @forelse($upcomingAgenda as $agenda)
                        <article wire:key="dash-agenda-{{ $agenda->id }}" class="px-6 py-4">
